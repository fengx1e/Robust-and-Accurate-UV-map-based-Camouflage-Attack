...
from rauca_utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes,  xyxy2xywhn,\
...
def extract_boxes(path='../coco128/'):  # from rauca_utils.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco128', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from rauca_utils.datasets import *; autosplit('../coco128')
    Arguments
