...
from rauca_utils.general import xywhn2xyxy, segments2boxes,  xyxy2xywhn
from rauca_utils.torch_utils import torch_distributed_zero_first
import rauca_utils.nmr_test as nmr
import time
# Parameters
help_url = 'https://github.com/ultralytics/yolov3/wiki/Train-Custom-Data'
img_formats = ['bmp', 'jpg', 'jpeg', 'png', 'tif', 'tiff', 'dng', 'webp', 'mpo', 'npz']  # acceptable image suffixes
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        if self.camou_scale != 1.0:
            imgs_pred = self._scale_camouflage(imgs_pred, self.camou_scale)
    ...
    @staticmethod
    def _scale_camouflage(tensor, scale):
