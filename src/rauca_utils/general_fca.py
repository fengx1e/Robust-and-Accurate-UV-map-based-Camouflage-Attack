...
from rauca_utils.google_utils import gsutil_getsize
from rauca_utils.metrics import fitness
from rauca_utils.torch_utils import init_torch_seeds
...
def strip_optimizer(f='best.pt', s=''):  # from rauca_utils.general import *; strip_optimizer()
